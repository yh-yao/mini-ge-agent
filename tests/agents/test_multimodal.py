...
from minigeagent.models.utils.openai_multimodal import (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Text before <MGEA_MULTIMODAL_CONTENT><CONTENT_TYPE>image_url</CONTENT_TYPE>https://example.com/image.png</MGEA_MULTIMODAL_CONTENT> text after",
            [
        ...
        (
            "<MGEA_MULTIMODAL_CONTENT><CONTENT_TYPE>image_url</CONTENT_TYPE>data:image/png;base64,iVBORw0KGgoAAAANS</MGEA_MULTIMODAL_CONTENT>",
...
def test_expand_content_string_multiple_images():
    ...
    content = (
        "First <MGEA_MULTIMODAL_CONTENT><CONTENT_TYPE>image_url</CONTENT_TYPE>image1.png</MGEA_MULTIMODAL_CONTENT> "
        "middle <MGEA_MULTIMODAL_CONTENT><CONTENT_TYPE>image_url</CONTENT_TYPE>image2.jpg</MGEA_MULTIMODAL_CONTENT> end"
    )
...
<MGEA_MULTIMODAL_CONTENT><CONTENT_TYPE>image_url</CONTENT_TYPE>data:image/png;base64,
iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk</MGEA_MULTIMODAL_CONTENT>
After image"""
    result = _expand_content_string(content=content, pattern=DEFAULT_MULTIMODAL_REGEX)
    assert len(result) == 3
...
def test_expand_content_string_whitespace_handling():
    ...
    content = "Text  \n<MGEA_MULTIMODAL_CONTENT><CONTENT_TYPE>image_url</CONTENT_TYPE>  image_url  </MGEA_MULTIMODAL_CONTENT>  \nMore text"
    result = _expand_content_string(content=content, pattern=DEFAULT_MULTIMODAL_REGEX)
...
def test_expand_content_string_adjacent_images():
    ...
    content = (
        "<MGEA_MULTIMODAL_CONTENT><CONTENT_TYPE>image_url</CONTENT_TYPE>img1</MGEA_MULTIMODAL_CONTENT>"
        "<MGEA_MULTIMODAL_CONTENT><CONTENT_TYPE>image_url</CONTENT_TYPE>img2</MGEA_MULTIMODAL_CONTENT>"
    )
    result = _expand_content_string(content=content, pattern=DEFAULT_MULTIMODAL_REGEX)
    assert len(result) == 2
...
def test_expand_multimodal_content_string():
    ...
    content = (
        "Text <MGEA_MULTIMODAL_CONTENT><CONTENT_TYPE>image_url</CONTENT_TYPE>image.png</MGEA_MULTIMODAL_CONTENT> more"
    )
...
def test_expand_multimodal_content_dict():
    ...
    content = {
        "role": "user",
        "content": "text <MGEA_MULTIMODAL_CONTENT><CONTENT_TYPE>image_url</CONTENT_TYPE>image.png</MGEA_MULTIMODAL_CONTENT>",
    }
    result = expand_multimodal_content(content, pattern=DEFAULT_MULTIMODAL_REGEX)
...
def test_expand_multimodal_content_nested():
    ...
    content = {
        "role": "user",
        "content": [
            "text <MGEA_MULTIMODAL_CONTENT><CONTENT_TYPE>image_url</CONTENT_TYPE>image.png</MGEA_MULTIMODAL_CONTENT>",
            {"nested": "value"},
        ],
    }
    result = expand_multimodal_content(content, pattern=DEFAULT_MULTIMODAL_REGEX)
...
def test_model_format_message_with_multimodal():
    ...
    result = model.format_message(
        role="user",
        content="Hello <MGEA_MULTIMODAL_CONTENT><CONTENT_TYPE>image_url</CONTENT_TYPE>image.png</MGEA_MULTIMODAL_CONTENT>",
    )
    assert result["role"] == "user"
    assert len(result["content"]) == 2
...
def test_unknown_content_type_ignored():
    ...
    content = (
        "Text <MGEA_MULTIMODAL_CONTENT><CONTENT_TYPE>unknown_type</CONTENT_TYPE>data</MGEA_MULTIMODAL_CONTENT> more"
    )
    result = _expand_content_string(content=content, pattern=DEFAULT_MULTIMODAL_REGEX)
