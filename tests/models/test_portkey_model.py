...
from minigeagent.models.portkey_model import PortkeyModel, PortkeyModelConfig
from minigeagent.models.utils.actions_toolcall import BASH_TOOL
...
def test_portkey_model_initialization():
    ...
    with patch("minigeagent.models.portkey_model.Portkey", mock_portkey_class):
...
def test_portkey_model_query():
    ...
    with patch("minigeagent.models.portkey_model.Portkey", mock_portkey_class):
        with patch.dict(os.environ, {"PORTKEY_API_KEY": "test-key"}):
            with patch("minigeagent.models.portkey_model.litellm.cost_calculator.completion_cost") as mock_cost:
...
def test_portkey_model_cost_tracking_ignore_errors():
    ...
    with patch("minigeagent.models.portkey_model.Portkey", mock_portkey_class):
        with patch.dict(os.environ, {"PORTKEY_API_KEY": "test-key"}):
            ...
            with patch(
                "minigeagent.models.portkey_model.litellm.cost_calculator.completion_cost",
    ...
    with patch("minigeagent.models.portkey_model.Portkey", mock_portkey_class):
        with patch.dict(os.environ, {"PORTKEY_API_KEY": "test-key"}):
            ...
            with patch("minigeagent.models.portkey_model.litellm.cost_calculator.completion_cost") as mock_cost:
                ...
                assert "MGEA_COST_TRACKING='ignore_errors'" in str(exc_info.value)
