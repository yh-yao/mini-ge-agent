...
from minigeagent.models.openrouter_model import (
    OpenRouterAuthenticationError,
)
from minigeagent.models.openrouter_textbased_model import (
...
def test_openrouter_model_authentication_error():
    ...
    with patch.dict(os.environ, {"OPENROUTER_API_KEY": "invalid-key"}):
        ...
        with patch("requests.post") as mock_post:
            ...
            assert "mini-ge-extra config set OPENROUTER_API_KEY" in str(exc_info.value)
