...
from minigeagent.models.litellm_model import LitellmModel, LitellmModelConfig
...
class TestLitellmModel:
    @patch("minigeagent.models.litellm_model.litellm.completion")
    @patch("minigeagent.models.litellm_model.litellm.cost_calculator.completion_cost")
