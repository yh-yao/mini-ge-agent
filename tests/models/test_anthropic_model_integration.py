...
def test_sonnet_4_cache_control_integration():
    ...
    with patch("minigeagent.models.litellm_model.litellm.completion") as mock_completion:
        mock_completion.return_value = _mock_litellm_completion("```mswea_bash_command\necho 'I can help!'\n```")

        with patch("minigeagent.models.litellm_model.litellm.cost_calculator.completion_cost") as mock_cost:
