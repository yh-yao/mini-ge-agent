...
from minigeagent.run.utilities.inspector import TrajectoryInspector, main
...
@patch("minigeagent.run.utilities.inspector.TrajectoryInspector.run")
def test_main_no_reasoning_flag(mock_run, temp_trajectory_files):
    ...
    with patch("minigeagent.run.utilities.inspector.TrajectoryInspector.__init__", return_value=None) as mock_init:
