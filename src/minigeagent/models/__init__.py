...
class GlobalModelStats:
    ...
    def __init__(self):
        ...
        self.cost_limit = float(os.getenv("MGEA_GLOBAL_COST_LIMIT", "0"))
        self.call_limit = int(os.getenv("MGEA_GLOBAL_CALL_LIMIT", "0"))
        if (self.cost_limit > 0 or self.call_limit > 0) and not os.getenv("MGEA_SILENT_STARTUP"):
...
def get_model_name(input_model_name: str | None = None, config: dict | None = None) -> str:
    ...
    if from_config := config.get("model_name"):
        return from_config
    if from_env := os.getenv("MGEA_MODEL_NAME"):
        return from_env
    raise ValueError("No default model set. Please run `mini-ge-extra config setup` to set one.")


_MODEL_CLASS_MAPPING = {
    "litellm": "minigeagent.models.litellm_model.LitellmModel",
    "litellm_textbased": "minigeagent.models.litellm_textbased_model.LitellmTextbasedModel",
    "litellm_response": "minigeagent.models.litellm_response_model.LitellmResponseModel",
    "openrouter": "minigeagent.models.openrouter_model.OpenRouterModel",
    "openrouter_textbased": "minigeagent.models.openrouter_textbased_model.OpenRouterTextbasedModel",
    "openrouter_response": "minigeagent.models.openrouter_response_model.OpenRouterResponseModel",
    "portkey": "minigeagent.models.portkey_model.PortkeyModel",
    "portkey_response": "minigeagent.models.portkey_response_model.PortkeyResponseAPIModel",
    "requesty": "minigeagent.models.requesty_model.RequestyModel",
    "deterministic": "minigeagent.models.test_models.DeterministicModel",
}
...
def get_model_class(model_name: str, model_class: str = "") -> type:
    ...
    e.g., "anthropic" or "minigeagent.models.anthropic.AnthropicModel"),
