...
from minigeagent.models.utils.actions_toolcall import (
    BASH_TOOL,
    format_toolcall_observation_messages,
    parse_toolcall_actions,
)
from minigeagent.models.utils.anthropic_utils import _reorder_anthropic_thinking_blocks
from minigeagent.models.utils.cache_control import set_cache_control
from minigeagent.models.utils.openai_multimodal import expand_multimodal_content
from minigeagent.models.utils.retry import retry
...
class OpenRouterModelConfig(BaseModel):
    ...
    cost_tracking: Literal["default", "ignore_errors"] = os.getenv("MGEA_COST_TRACKING", "default")
    ...
    def _query(self, messages: list[dict[str, str]], **kwargs):
        ...
        try:
            ...
            if response.status_code == 401:
                error_msg = "Authentication failed. You can permanently set your API key with `mini-ge-extra config set OPENROUTER_API_KEY YOUR_KEY`."
    ...
    def _calculate_cost(self, response) -> dict[str, float]:
        ...
        if cost <= 0.0 and self.config.cost_tracking != "ignore_errors":
            raise RuntimeError(
                ...
                "export MGEA_COST_TRACKING='ignore_errors' to ignore cost tracking errors "
