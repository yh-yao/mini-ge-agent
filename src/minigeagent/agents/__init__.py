"""Agent implementations for mini-ge-agent."""

import copy
import importlib

from minigeagent import Agent, Environment, Model

_AGENT_MAPPING = {
    "default": "minigeagent.agents.default.DefaultAgent",
    "graph": "minigeagent.agents.graph.GraphAgent",
    "interactive": "minigeagent.agents.interactive.InteractiveAgent",
}
