"""Run mini-ge-agent on ProgramBench instances in batch mode."""
...
_HELP_TEXT = """Run mini-ge-agent on ProgramBench instances.
...
def process_instance(
    ...
    try:
        ...
        env.execute(
            {"command": 'git config user.name "mini-ge-agent" && git config user.email "mini-ge-agent@proton.me"'}
        )
